		...
		"windows_options": {
			...
			Elem: &schema.Resource{Schema: map[string]*schema.Schema{
				...
				"domain_admin_user": {
					Type:          schema.TypeString,
					Optional:      true,
					ConflictsWith: []string{prefix + "windows_options.workgroup"},
					Description:   "The user account of the domain administrator used to join this virtual machine to the domain.",
					RequiredWith:  []string{prefix + "windows_options.join_domain"},
				},
				...
				"join_domain": {
					...
					RequiredWith:  []string{prefix + "windows_options.domain_admin_user", prefix + "windows_options.domain_admin_password"},
				},
				"workgroup": {
					Type:          schema.TypeString,
					Optional:      true,
					ConflictsWith: []string{prefix + "windows_options.join_domain"},
